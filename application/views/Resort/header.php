...
<head>
	...
	<link rel="canonical" href="https://aspirevillastays.com/destinationsResort/<?php echo $resort_des[0]['des_name']; ?>/<?php if(!empty($SEO_status)){ echo $SEO_status[0]['rm_keyword']; } ?>">
	...
	<div class="theme-config">
	    <div class="theme-config-box verify" id="spin">
	        <div class="spin-icon" id="spin-this">
	           ...
	           <i class="fa fa-envelope fa-lg" style="color:#FFFFFF;"> &nbsp; &nbsp;<span style="writing-mode: vertical-rl;transform: rotate(180deg);"> Send Inquiry </span> </i>
	        </div>
	...
	<div id="demo-1" data-zs-src='["<?=base_url()?>assets/images/4.jpg"]' data-zs-overlay="dots">
		<div class="demo-inner-content">
			...
			<div class="header-w3-agileits">
				...
				<div class="inner-header-agile" style="padding: 1em 0.5em;box-shadow: 0px 2px #eee;">	
					<nav class="navbar navbar-default">
