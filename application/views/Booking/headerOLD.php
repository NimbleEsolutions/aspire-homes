	...
	<div id="demo-1" data-zs-src='["<?=base_url()?>assets/images/4.jpg"]' data-zs-overlay="dots">
		<div class="demo-inner-content">
			...
			<div class="header-w3-agileits">
				<div class="inner-header-agile" style="background:#d2d0cf">	
					<nav class="navbar navbar-default">
						...
						<!-- <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav" style="margin-left: 17em;    margin-top: 2em;">
				...
				<div class="inner-header-agile" style="background: rgb(41 42 43/67%);   padding: 1em 0.5em;">	
					<nav class="navbar navbar-default">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav" style="margin-left: 18%;">
								...
								<li><a href="https://aspirevillastays-com.rays.link/Blog/aspire-apt/" target="_blank">Gallery</a></li>
